...
export default function ConfirmedScreen({
  ...
  return (
    <div className="flex flex-col gap-6 pb-24 font-sans">
      ...
      <div className="px-5">
        <div className="relative h-64 w-full rounded-2xl overflow-hidden shadow-sm border border-brand-primary/5">
          <img 
          ...
          <h2 className="absolute bottom-4 left-5 right-5 font-serif text-xl font-bold text-white leading-tight">
            {experience.title}
          </h2>
        </div>
      </div>
      ...
      <div className="px-5">
        <div 
          className="p-5 bg-white border border-brand-primary/10 rounded-2xl flex flex-col md:flex-row gap-5 items-center relative overflow-hidden shadow-sm"
          style={{
        ...
        >
          ...
          <div className="flex-1 flex flex-col gap-4 w-full">
            <h3 className="font-serif text-lg font-bold text-brand-primary leading-none">Datos de la Reserva</h3>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="flex flex-col">
                  <span className="text-[9px] text-[#8a726c] font-bold uppercase tracking-wider">Fecha</span>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="flex flex-col">
                  <span className="text-[9px] text-[#8a726c] font-bold uppercase tracking-wider">Horario</span>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="flex flex-col">
                  <span className="text-[9px] text-[#8a726c] font-bold uppercase tracking-wider">Participantes</span>
          ...
          <div className="w-full md:w-36 flex flex-col items-center justify-center p-3 bg-white rounded-xl border border-brand-primary/10 shrink-0 shadow-sm">
      ...
      <div className="px-5">
        <div className="p-4 bg-brand-tertiary/5 border border-brand-tertiary/15 rounded-2xl flex flex-col gap-2 shadow-sm">
          <div className="flex items-center gap-1.5 text-brand-tertiary">
            <CheckCircle2 className="w-4 h-4" />
            <h4 className="text-[10px] font-bold uppercase tracking-wider leading-none">Impacto Comunitario</h4>
          </div>
          <p className="text-xs text-brand-text-dark font-medium leading-relaxed">
            Tu reserva apoya directamente a <span className="font-bold text-brand-tertiary">familias locales</span> preservando sus cultivos de café orgánicos y métodos patrimoniales.
          </p>
          <button className="text-[10px] font-bold text-brand-primary hover:underline flex items-center gap-1.5 self-start mt-1 bg-brand-primary/5 py-1 px-2.5 rounded-full border border-brand-primary/5">
      ...
      <div className="px-5">
        <div className="bg-white rounded-2xl border border-brand-primary/5 shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="p-4 flex flex-col">
            <span className="text-[10px] font-bold text-[#8a726c] uppercase tracking-wider">Cómo llegar</span>
            <span className="text-xs font-bold text-brand-text-dark mt-1 leading-tight">{experience.howToGetThere.title}</span>
            ...
            <button 
              ...
              className="mt-3.5 text-center border border-brand-secondary text-brand-secondary hover:bg-brand-secondary hover:text-white px-4 py-2.5 rounded-full text-xs font-bold transition-all active:scale-95 shadow-sm"
            >
      ...
      <div className="px-5 pb-6 flex flex-col gap-3">
        <button 
          ...
          className="w-full bg-brand-primary text-white font-bold py-3.5 px-6 rounded-full shadow-md active:scale-95 transition-transform flex items-center justify-center gap-2 text-xs"
        >
        ...
        <button 
          ...
          className="w-full border border-brand-primary/15 text-brand-text-dark font-bold py-3.5 px-6 rounded-full hover:bg-neutral-50 active:scale-95 transition-transform flex items-center justify-center gap-2 text-xs"
        >
